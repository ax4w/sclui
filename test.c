...
void thrdScreen() { 
  ...
  sclui_screen *s3 = initScreen("3. Screen", 9, 1, 1, 40, 20, KEY_UP, KEY_DOWN);
...
void sndScreen() {
  ...
  sclui_screen *s2 = initScreen("Hello World", 11, 3, 1, 40 , 20, KEY_UP, KEY_DOWN);
  name = createTextBox("Name", 15, 5, 4, 20);
